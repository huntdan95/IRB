    ...
    <div>
      ...
      <section className="py-20 px-4 bg-shell">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-4xl md:text-5xl mb-6 text-deep-ocean">
          ...
          <p className="text-lg text-driftwood leading-relaxed mb-8">
            ...
            appointed beachfront condos. Located directly on the Gulf of Mexico, these properties
            offer stunning ocean views, direct beach access, and all the comforts of home.
          </p>
